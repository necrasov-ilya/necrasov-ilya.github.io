  ...
  links: [
    {
      label: 'GitHub',
      value: 'necrasov-ilya',
      href: 'https://github.com/necrasov-ilya',
    },
    {
      label: 'Email',
...
export const galleryAssets = {
  ...
  darkStills: [
    ...
    '/media/hero/stills/dark/hero-still-dark-03.webp',
  ],
  lightStills: [
    '/media/hero/stills/light/hero-still-light-01.webp',
    '/media/hero/stills/light/hero-still-light-02.webp',
    '/media/hero/stills/light/hero-still-light-03.webp',
  ],
  logos: [
    '/media/hero/logo/logo-nksv-filled.svg',
    '/media/hero/logo/logo-nksv-outline.svg',
    '/media/hero/logo/logo-nksv-mark-filled.svg',
    '/media/hero/logo/logo-nksv-mark-outlined.svg',
  ],
};
