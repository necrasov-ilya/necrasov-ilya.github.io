...
export function StartMenu({ apps, isOpen, windows, onOpen, onOpenPortfolio }: StartMenuProps) {
  return (
    <aside className={`start-menu ${isOpen ? 'is-open' : ''}`}>
      <button className="start-menu__profile" onClick={onOpenPortfolio} type="button">
